...
window.configure(bg='#C7F9CC')


row0_col0 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row0_col0))
row0_col1 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row0_col1))
row0_col2 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row0_col2))
row0_col3 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row0_col3))

row1_col0 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row1_col0))
row1_col1 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row1_col1))
row1_col2 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row1_col2))
row1_col3 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row1_col3))

row2_col0 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row2_col0))
row2_col1 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row2_col1))
row2_col2 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row2_col2))
row2_col3 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row2_col3))

row3_col0 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row3_col0))
row3_col1 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row3_col1))
row3_col2 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row3_col2))
row3_col3 = Button(window, text="0", bg='#57CC99', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click_grid(row3_col3))

instructions = Label(window, bg='#C7F9CC', fg='#22577A', text = "Press the bottom buttons or type to enter a value,\npress the corresponding table cell to change it!\n\nWhen you're ready to interpolate,\npress the \"Ready to Interpolate\" button.")
...
button_0 = Button(window, text="0", bg='#38A3A5', fg='#C7F9CC', padx=40, pady=20, command=lambda: user_click(0))

button_1 = Button(window, text="1", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(1))
button_2 = Button(window, text="2", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(2))
button_3 = Button(window, text="3", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(3))

button_4 = Button(window, text="4", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(4))
button_5 = Button(window, text="5", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(5))
button_6 = Button(window, text="6", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(6))

button_7 = Button(window, text="7", bg='#38A3A5', fg='#C7F9CC',padx=40, pady=20, command=lambda: user_click(7))
